...
func (r *listingResolver) Source(ctx context.Context, obj *ent.Listing) (*model.ListingSource, error) {
	panic(fmt.Errorf("not implemented: Source - source"))
}

// WyvernOrder is the resolver for the wyvernOrder field.
...
// SeaportOrder is the resolver for the seaportOrder field.
...
// WalletItems is the resolver for the walletItems field.
...
// Maker is the resolver for the maker field.
...
// ListingTime is the resolver for the listingTime field.
...
// ExpirationTime is the resolver for the expirationTime field.
...
// FeeRecipient is the resolver for the feeRecipient field.
...
// Calldata is the resolver for the calldata field.
...
// ReplacementPattern is the resolver for the replacementPattern field.
...
// StaticTarget is the resolver for the staticTarget field.
func (r *wyvernOrderResolver) StaticTarget(ctx context.Context, obj *opensea.WyvernOrder) (string, error) {
	return obj.Target.Hex(), nil
}

// StaticExtradata is the resolver for the staticExtradata field.
