...
func (ec *executionContext) unmarshalInputDopeWhereInput(ctx context.Context, obj interface{}) (ent.DopeWhereInput, error) {
	...
	for k, v := range asMap {
		...
		case "salepriceNEQ":
			...
			it.SalePriceNEQ, err = ec.unmarshalOFloat2ᚖfloat64(ctx, v)
			if err != nil {
				return it, err
			}
		case "salepriceIn":
			...
			it.SalePriceIn, err = ec.unmarshalOFloat2ᚕfloat64ᚄ(ctx, v)
			if err != nil {
				return it, err
			}
		case "salepriceNotIn":
			...
			it.SalePriceNotIn, err = ec.unmarshalOFloat2ᚕfloat64ᚄ(ctx, v)
			if err != nil {
				return it, err
			}
		case "salepriceGT":
			...
			it.SalePriceGT, err = ec.unmarshalOFloat2ᚖfloat64(ctx, v)
			if err != nil {
				return it, err
			}
		case "salepriceGTE":
			...
			it.SalePriceGTE, err = ec.unmarshalOFloat2ᚖfloat64(ctx, v)
			if err != nil {
				return it, err
			}
		case "salepriceLT":
			...
			it.SalePriceLT, err = ec.unmarshalOFloat2ᚖfloat64(ctx, v)
			if err != nil {
				return it, err
			}
		case "salepriceLTE":
