...
func (ec *EventCreate) createSpec() (*Event, *sqlgraph.CreateSpec) {
	...
	if value, ok := ec.mutation.Address(); ok {
		_spec.SetField(event.FieldAddress, field.TypeBytes, value)
		_node.Address = value
	}
	if value, ok := ec.mutation.Index(); ok {
		_spec.SetField(event.FieldIndex, field.TypeUint64, value)
		_node.Index = value
	}
	if value, ok := ec.mutation.Hash(); ok {
		_spec.SetField(event.FieldHash, field.TypeBytes, value)
		_node.Hash = value
	}
