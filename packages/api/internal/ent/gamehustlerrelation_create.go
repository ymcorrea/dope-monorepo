...
func (ghrc *GameHustlerRelationCreate) Save(ctx context.Context) (*GameHustlerRelation, error) {
	return withHooks[*GameHustlerRelation, GameHustlerRelationMutation](ctx, ghrc.sqlSave, ghrc.mutation, ghrc.hooks)
}
...
func (ghrc *GameHustlerRelationCreate) sqlSave(ctx context.Context) (*GameHustlerRelation, error) {
	...
	ghrc.mutation.id = &_node.ID
	ghrc.mutation.done = true
	return _node, nil
}
...
func (ghrc *GameHustlerRelationCreate) createSpec() (*GameHustlerRelation, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(gamehustlerrelation.Table, sqlgraph.NewFieldSpec(gamehustlerrelation.FieldID, field.TypeString))
	)
