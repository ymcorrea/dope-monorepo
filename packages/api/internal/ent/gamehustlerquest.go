...
func (ghq *GameHustlerQuest) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		default:
			ghq.selectValues.Set(columns[i], values[i])
		}
	}
	return nil
}

// Value returns the ent.Value that was dynamically selected and assigned to the GameHustlerQuest.
// This includes values selected through modifiers, order, etc.
func (ghq *GameHustlerQuest) Value(name string) (ent.Value, error) {
	return ghq.selectValues.Get(name)
}
