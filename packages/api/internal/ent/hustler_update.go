...
func (hu *HustlerUpdate) Save(ctx context.Context) (int, error) {
	return withHooks[int, HustlerMutation](ctx, hu.sqlSave, hu.mutation, hu.hooks)
}
...
func (huo *HustlerUpdateOne) Save(ctx context.Context) (*Hustler, error) {
	return withHooks[*Hustler, HustlerMutation](ctx, huo.sqlSave, huo.mutation, huo.hooks)
}
