...
func (hu *HustlerUpdate) SetNillableAge(u *uint64) *HustlerUpdate {
	if u != nil {
		hu.SetAge(*u)
	}
	return hu
...
// AppendViewbox appends i to the "viewbox" field.
func (hu *HustlerUpdate) AppendViewbox(i []int) *HustlerUpdate {
	hu.mutation.AppendViewbox(i)
	return hu
}
...
// AppendOrder appends i to the "order" field.
func (hu *HustlerUpdate) AppendOrder(i []int) *HustlerUpdate {
	hu.mutation.AppendOrder(i)
	return hu
}
...
func (hu *HustlerUpdate) SetBestAskPriceEth(f float64) *HustlerUpdate {
	hu.mutation.ResetBestAskPriceEth()
	hu.mutation.SetBestAskPriceEth(f)
	return hu
}

// SetNillableBestAskPriceEth sets the "best_ask_price_eth" field if the given value is not nil.
func (hu *HustlerUpdate) SetNillableBestAskPriceEth(f *float64) *HustlerUpdate {
	if f != nil {
		hu.SetBestAskPriceEth(*f)
	}
	return hu
}

// AddBestAskPriceEth adds f to the "best_ask_price_eth" field.
func (hu *HustlerUpdate) AddBestAskPriceEth(f float64) *HustlerUpdate {
	hu.mutation.AddBestAskPriceEth(f)
	return hu
}

// ClearBestAskPriceEth clears the value of the "best_ask_price_eth" field.
func (hu *HustlerUpdate) ClearBestAskPriceEth() *HustlerUpdate {
	hu.mutation.ClearBestAskPriceEth()
	return hu
}
...
func (hu *HustlerUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(hustler.Table, hustler.Columns, sqlgraph.NewFieldSpec(hustler.FieldID, field.TypeString))
	...
	if value, ok := hu.mutation.Name(); ok {
		_spec.SetField(hustler.FieldName, field.TypeString, value)
	}
	if hu.mutation.NameCleared() {
		_spec.ClearField(hustler.FieldName, field.TypeString)
	}
	if value, ok := hu.mutation.Title(); ok {
		_spec.SetField(hustler.FieldTitle, field.TypeString, value)
	}
	if hu.mutation.TitleCleared() {
		_spec.ClearField(hustler.FieldTitle, field.TypeString)
	}
	if value, ok := hu.mutation.Color(); ok {
		_spec.SetField(hustler.FieldColor, field.TypeString, value)
	}
	if hu.mutation.ColorCleared() {
		_spec.ClearField(hustler.FieldColor, field.TypeString)
	}
	if value, ok := hu.mutation.Background(); ok {
		_spec.SetField(hustler.FieldBackground, field.TypeString, value)
	}
	if hu.mutation.BackgroundCleared() {
		_spec.ClearField(hustler.FieldBackground, field.TypeString)
	}
	if value, ok := hu.mutation.Age(); ok {
		_spec.SetField(hustler.FieldAge, field.TypeUint64, value)
	}
	if value, ok := hu.mutation.AddedAge(); ok {
		_spec.AddField(hustler.FieldAge, field.TypeUint64, value)
	}
	if value, ok := hu.mutation.Sex(); ok {
		_spec.SetField(hustler.FieldSex, field.TypeEnum, value)
	}
	if value, ok := hu.mutation.Viewbox(); ok {
		_spec.SetField(hustler.FieldViewbox, field.TypeJSON, value)
	}
	if value, ok := hu.mutation.AppendedViewbox(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, hustler.FieldViewbox, value)
		})
	}
	if value, ok := hu.mutation.Order(); ok {
		_spec.SetField(hustler.FieldOrder, field.TypeJSON, value)
	}
	if value, ok := hu.mutation.AppendedOrder(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, hustler.FieldOrder, value)
		})
	}
	if value, ok := hu.mutation.Svg(); ok {
		_spec.SetField(hustler.FieldSvg, field.TypeString, value)
	}
	if hu.mutation.SvgCleared() {
		_spec.ClearField(hustler.FieldSvg, field.TypeString)
	}
	if value, ok := hu.mutation.BestAskPriceEth(); ok {
		_spec.SetField(hustler.FieldBestAskPriceEth, field.TypeFloat64, value)
	}
	if value, ok := hu.mutation.AddedBestAskPriceEth(); ok {
		_spec.AddField(hustler.FieldBestAskPriceEth, field.TypeFloat64, value)
	}
	if hu.mutation.BestAskPriceEthCleared() {
		_spec.ClearField(hustler.FieldBestAskPriceEth, field.TypeFloat64)
	}
	...
	if hu.mutation.BodyCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(bodypart.FieldID, field.TypeString),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
...
// SetNillableAge sets the "age" field if the given value is not nil.
func (huo *HustlerUpdateOne) SetNillableAge(u *uint64) *HustlerUpdateOne {
	if u != nil {
		huo.SetAge(*u)
	}
	return huo
...
// AppendViewbox appends i to the "viewbox" field.
func (huo *HustlerUpdateOne) AppendViewbox(i []int) *HustlerUpdateOne {
	huo.mutation.AppendViewbox(i)
	return huo
}
...
// AppendOrder appends i to the "order" field.
func (huo *HustlerUpdateOne) AppendOrder(i []int) *HustlerUpdateOne {
	huo.mutation.AppendOrder(i)
	return huo
}
...
// SetBestAskPriceEth sets the "best_ask_price_eth" field.
func (huo *HustlerUpdateOne) SetBestAskPriceEth(f float64) *HustlerUpdateOne {
	huo.mutation.ResetBestAskPriceEth()
	huo.mutation.SetBestAskPriceEth(f)
	return huo
}

// SetNillableBestAskPriceEth sets the "best_ask_price_eth" field if the given value is not nil.
func (huo *HustlerUpdateOne) SetNillableBestAskPriceEth(f *float64) *HustlerUpdateOne {
	if f != nil {
		huo.SetBestAskPriceEth(*f)
	}
	return huo
}

// AddBestAskPriceEth adds f to the "best_ask_price_eth" field.
func (huo *HustlerUpdateOne) AddBestAskPriceEth(f float64) *HustlerUpdateOne {
	huo.mutation.AddBestAskPriceEth(f)
	return huo
}

// ClearBestAskPriceEth clears the value of the "best_ask_price_eth" field.
func (huo *HustlerUpdateOne) ClearBestAskPriceEth() *HustlerUpdateOne {
	huo.mutation.ClearBestAskPriceEth()
	return huo
}
...
// Where appends a list predicates to the HustlerUpdate builder.
func (huo *HustlerUpdateOne) Where(ps ...predicate.Hustler) *HustlerUpdateOne {
...
func (huo *HustlerUpdateOne) sqlSave(ctx context.Context) (_node *Hustler, err error) {
	...
	if value, ok := huo.mutation.AppendedViewbox(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, hustler.FieldViewbox, value)
		})
	}
	...
	if value, ok := huo.mutation.AppendedOrder(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, hustler.FieldOrder, value)
		})
	}
	...
	if value, ok := huo.mutation.BestAskPriceEth(); ok {
		_spec.SetField(hustler.FieldBestAskPriceEth, field.TypeFloat64, value)
	}
	if value, ok := huo.mutation.AddedBestAskPriceEth(); ok {
		_spec.AddField(hustler.FieldBestAskPriceEth, field.TypeFloat64, value)
	}
	if huo.mutation.BestAskPriceEthCleared() {
		_spec.ClearField(hustler.FieldBestAskPriceEth, field.TypeFloat64)
	}
