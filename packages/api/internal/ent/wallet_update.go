...
func (wu *WalletUpdate) SetLastSetPaperBalanceAt(t time.Time) *WalletUpdate {
	wu.mutation.SetLastSetPaperBalanceAt(t)
	return wu
}

// SetNillableLastSetPaperBalanceAt sets the "last_set_paper_balance_at" field if the given value is not nil.
func (wu *WalletUpdate) SetNillableLastSetPaperBalanceAt(t *time.Time) *WalletUpdate {
	if t != nil {
		wu.SetLastSetPaperBalanceAt(*t)
	}
	return wu
}

// ClearLastSetPaperBalanceAt clears the value of the "last_set_paper_balance_at" field.
func (wu *WalletUpdate) ClearLastSetPaperBalanceAt() *WalletUpdate {
	wu.mutation.ClearLastSetPaperBalanceAt()
	return wu
}
...
func (wu *WalletUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := wu.mutation.AddedPaper(); ok {
		_spec.AddField(wallet.FieldPaper, field.TypeInt, value)
	}
	if value, ok := wu.mutation.LastSetPaperBalanceAt(); ok {
		_spec.SetField(wallet.FieldLastSetPaperBalanceAt, field.TypeTime, value)
	}
	if wu.mutation.LastSetPaperBalanceAtCleared() {
		_spec.ClearField(wallet.FieldLastSetPaperBalanceAt, field.TypeTime)
	}
...
// SetLastSetPaperBalanceAt sets the "last_set_paper_balance_at" field.
func (wuo *WalletUpdateOne) SetLastSetPaperBalanceAt(t time.Time) *WalletUpdateOne {
	wuo.mutation.SetLastSetPaperBalanceAt(t)
	return wuo
}

// SetNillableLastSetPaperBalanceAt sets the "last_set_paper_balance_at" field if the given value is not nil.
func (wuo *WalletUpdateOne) SetNillableLastSetPaperBalanceAt(t *time.Time) *WalletUpdateOne {
	if t != nil {
		wuo.SetLastSetPaperBalanceAt(*t)
	}
	return wuo
}

// ClearLastSetPaperBalanceAt clears the value of the "last_set_paper_balance_at" field.
func (wuo *WalletUpdateOne) ClearLastSetPaperBalanceAt() *WalletUpdateOne {
	wuo.mutation.ClearLastSetPaperBalanceAt()
	return wuo
}
...
func (wuo *WalletUpdateOne) sqlSave(ctx context.Context) (_node *Wallet, err error) {
	...
	if value, ok := wuo.mutation.LastSetPaperBalanceAt(); ok {
		_spec.SetField(wallet.FieldLastSetPaperBalanceAt, field.TypeTime, value)
	}
	if wuo.mutation.LastSetPaperBalanceAtCleared() {
		_spec.ClearField(wallet.FieldLastSetPaperBalanceAt, field.TypeTime)
	}
