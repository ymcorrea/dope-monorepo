...
type GameHustlerQuestQuery struct {
	config
	ctx         *QueryContext
	order       []gamehustlerquest.OrderOption
	inters      []Interceptor
...
func (ghqq *GameHustlerQuestQuery) Order(o ...gamehustlerquest.OrderOption) *GameHustlerQuestQuery {
...
func (ghqq *GameHustlerQuestQuery) Clone() *GameHustlerQuestQuery {
	...
	return &GameHustlerQuestQuery{
		config:      ghqq.config,
		ctx:         ghqq.ctx.Clone(),
		order:       append([]gamehustlerquest.OrderOption{}, ghqq.order...),
