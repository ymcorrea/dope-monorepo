...
// SetNillableLastPosition sets the "last_position" field if the given value is not nil.
func (ghu *GameHustlerUpdate) SetNillableLastPosition(s *schema.Position) *GameHustlerUpdate {
	if s != nil {
		ghu.SetLastPosition(*s)
	}
	return ghu
}
...
// SetNillableLastPosition sets the "last_position" field if the given value is not nil.
func (ghuo *GameHustlerUpdateOne) SetNillableLastPosition(s *schema.Position) *GameHustlerUpdateOne {
	if s != nil {
		ghuo.SetLastPosition(*s)
	}
	return ghuo
}
