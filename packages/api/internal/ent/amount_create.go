...
func (ac *AmountCreate) Save(ctx context.Context) (*Amount, error) {
	ac.defaults()
	return withHooks[*Amount, AmountMutation](ctx, ac.sqlSave, ac.mutation, ac.hooks)
}
...
func (ac *AmountCreate) createSpec() (*Amount, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(amount.Table, sqlgraph.NewFieldSpec(amount.FieldID, field.TypeString))
	)
	...
	if value, ok := ac.mutation.GetType(); ok {
		_spec.SetField(amount.FieldType, field.TypeEnum, value)
		_node.Type = value
	}
