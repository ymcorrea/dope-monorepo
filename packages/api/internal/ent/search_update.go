...
func (su *SearchUpdate) SetNillableClaimed(b *bool) *SearchUpdate {
	if b != nil {
		su.SetClaimed(*b)
	}
	return su
...
func (su *SearchUpdate) SetNillableOpened(b *bool) *SearchUpdate {
	if b != nil {
		su.SetOpened(*b)
	}
	return su
...
func (su *SearchUpdate) SetBanned(b bool) *SearchUpdate {
	su.mutation.SetBanned(b)
	return su
}

// SetNillableBanned sets the "banned" field if the given value is not nil.
func (su *SearchUpdate) SetNillableBanned(b *bool) *SearchUpdate {
	if b != nil {
		su.SetBanned(*b)
	}
	return su
...
func (su *SearchUpdate) SetSalePrice(f float64) *SearchUpdate {
	su.mutation.ResetSalePrice()
	su.mutation.SetSalePrice(f)
	return su
}

// SetNillableSalePrice sets the "sale_price" field if the given value is not nil.
func (su *SearchUpdate) SetNillableSalePrice(f *float64) *SearchUpdate {
	if f != nil {
		su.SetSalePrice(*f)
	}
	return su
...
func (su *SearchUpdate) AddSalePrice(f float64) *SearchUpdate {
	su.mutation.AddSalePrice(f)
	return su
}

// ClearSalePrice clears the value of the "sale_price" field.
func (su *SearchUpdate) ClearSalePrice() *SearchUpdate {
	su.mutation.ClearSalePrice()
	return su
}
...
func (su *SearchUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(search.Table, search.Columns, sqlgraph.NewFieldSpec(search.FieldID, field.TypeString))
	...
	if value, ok := su.mutation.AddedGreatness(); ok {
		_spec.AddField(search.FieldGreatness, field.TypeInt, value)
	}
	if su.mutation.GreatnessCleared() {
		_spec.ClearField(search.FieldGreatness, field.TypeInt)
	}
	...
	if value, ok := su.mutation.Banned(); ok {
	...
	if value, ok := su.mutation.AddedSalePrice(); ok {
		_spec.AddField(search.FieldSalePrice, field.TypeFloat64, value)
	}
	if su.mutation.SalePriceCleared() {
		_spec.ClearField(search.FieldSalePrice, field.TypeFloat64)
	}
...
// SetNillableClaimed sets the "claimed" field if the given value is not nil.
func (suo *SearchUpdateOne) SetNillableClaimed(b *bool) *SearchUpdateOne {
	if b != nil {
		suo.SetClaimed(*b)
	}
	return suo
...
// SetNillableOpened sets the "opened" field if the given value is not nil.
func (suo *SearchUpdateOne) SetNillableOpened(b *bool) *SearchUpdateOne {
	if b != nil {
		suo.SetOpened(*b)
	}
	return suo
...
// SetBanned sets the "banned" field.
func (suo *SearchUpdateOne) SetBanned(b bool) *SearchUpdateOne {
	suo.mutation.SetBanned(b)
	return suo
}

// SetNillableBanned sets the "banned" field if the given value is not nil.
func (suo *SearchUpdateOne) SetNillableBanned(b *bool) *SearchUpdateOne {
	if b != nil {
		suo.SetBanned(*b)
	}
	return suo
...
// SetSalePrice sets the "sale_price" field.
func (suo *SearchUpdateOne) SetSalePrice(f float64) *SearchUpdateOne {
	suo.mutation.ResetSalePrice()
	suo.mutation.SetSalePrice(f)
	return suo
}

// SetNillableSalePrice sets the "sale_price" field if the given value is not nil.
func (suo *SearchUpdateOne) SetNillableSalePrice(f *float64) *SearchUpdateOne {
	if f != nil {
		suo.SetSalePrice(*f)
	}
	return suo
...
// AddSalePrice adds f to the "sale_price" field.
func (suo *SearchUpdateOne) AddSalePrice(f float64) *SearchUpdateOne {
	suo.mutation.AddSalePrice(f)
	return suo
}

// ClearSalePrice clears the value of the "sale_price" field.
func (suo *SearchUpdateOne) ClearSalePrice() *SearchUpdateOne {
	suo.mutation.ClearSalePrice()
	return suo
}
...
// Where appends a list predicates to the SearchUpdate builder.
func (suo *SearchUpdateOne) Where(ps ...predicate.Search) *SearchUpdateOne {
...
func (suo *SearchUpdateOne) sqlSave(ctx context.Context) (_node *Search, err error) {
	...
	if value, ok := suo.mutation.Banned(); ok {
		_spec.SetField(search.FieldBanned, field.TypeBool, value)
	}
	...
	if suo.mutation.SalePriceCleared() {
		_spec.ClearField(search.FieldSalePrice, field.TypeFloat64)
	}
