...
func (su *SearchUpdate) Save(ctx context.Context) (int, error) {
	return withHooks[int, SearchMutation](ctx, su.sqlSave, su.mutation, su.hooks)
}
...
func (su *SearchUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := su.mutation.SaleActive(); ok {
		_spec.SetField(search.FieldSaleActive, field.TypeBool, value)
	}
	if value, ok := su.mutation.SalePrice(); ok {
		_spec.SetField(search.FieldSalePrice, field.TypeInt, value)
	}
	if value, ok := su.mutation.AddedSalePrice(); ok {
		_spec.AddField(search.FieldSalePrice, field.TypeInt, value)
	}
	if value, ok := su.mutation.LastSalePrice(); ok {
		_spec.SetField(search.FieldLastSalePrice, field.TypeInt, value)
	}
	if value, ok := su.mutation.AddedLastSalePrice(); ok {
		_spec.AddField(search.FieldLastSalePrice, field.TypeInt, value)
	}
...
func (suo *SearchUpdateOne) Save(ctx context.Context) (*Search, error) {
	return withHooks[*Search, SearchMutation](ctx, suo.sqlSave, suo.mutation, suo.hooks)
}
