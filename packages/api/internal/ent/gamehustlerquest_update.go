...
// SetNillableQuest sets the "quest" field if the given value is not nil.
func (ghqu *GameHustlerQuestUpdate) SetNillableQuest(s *string) *GameHustlerQuestUpdate {
	if s != nil {
		ghqu.SetQuest(*s)
	}
	return ghqu
...
func (ghqu *GameHustlerQuestUpdate) Save(ctx context.Context) (int, error) {
	return withHooks(ctx, ghqu.sqlSave, ghqu.mutation, ghqu.hooks)
}
...
// SetNillableQuest sets the "quest" field if the given value is not nil.
func (ghquo *GameHustlerQuestUpdateOne) SetNillableQuest(s *string) *GameHustlerQuestUpdateOne {
	if s != nil {
		ghquo.SetQuest(*s)
	}
	return ghquo
...
func (ghquo *GameHustlerQuestUpdateOne) Save(ctx context.Context) (*GameHustlerQuest, error) {
	return withHooks(ctx, ghquo.sqlSave, ghquo.mutation, ghquo.hooks)
}
