...
func (ghiu *GameHustlerItemUpdate) SetNillableItem(s *string) *GameHustlerItemUpdate {
	if s != nil {
		ghiu.SetItem(*s)
	}
	return ghiu
...
func (ghiu *GameHustlerItemUpdate) Save(ctx context.Context) (int, error) {
	return withHooks(ctx, ghiu.sqlSave, ghiu.mutation, ghiu.hooks)
}
...
// SetNillableItem sets the "item" field if the given value is not nil.
func (ghiuo *GameHustlerItemUpdateOne) SetNillableItem(s *string) *GameHustlerItemUpdateOne {
	if s != nil {
		ghiuo.SetItem(*s)
	}
	return ghiuo
...
func (ghiuo *GameHustlerItemUpdateOne) Save(ctx context.Context) (*GameHustlerItem, error) {
	return withHooks(ctx, ghiuo.sqlSave, ghiuo.mutation, ghiuo.hooks)
}
