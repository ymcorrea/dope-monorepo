...
func (iq *ItemQuery) loadWallets(ctx context.Context, query *WalletItemsQuery, nodes []*Item, init func(*Item), assign func(*Item, *WalletItems)) error {
	...
	query.Where(predicate.WalletItems(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(item.WalletsColumn), fks...))
	}))
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "item_wallets" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (iq *ItemQuery) loadHustlerWeapons(ctx context.Context, query *HustlerQuery, nodes []*Item, init func(*Item), assign func(*Item, *Hustler)) error {
	...
	query.Where(predicate.Hustler(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(item.HustlerWeaponsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "item_hustler_weapons" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (iq *ItemQuery) loadHustlerClothes(ctx context.Context, query *HustlerQuery, nodes []*Item, init func(*Item), assign func(*Item, *Hustler)) error {
	...
	query.withFKs = true
	query.Where(predicate.Hustler(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(item.HustlerClothesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "item_hustler_clothes" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (iq *ItemQuery) loadHustlerVehicles(ctx context.Context, query *HustlerQuery, nodes []*Item, init func(*Item), assign func(*Item, *Hustler)) error {
	...
	query.withFKs = true
	query.Where(predicate.Hustler(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(item.HustlerVehiclesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "item_hustler_vehicles" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (iq *ItemQuery) loadHustlerWaists(ctx context.Context, query *HustlerQuery, nodes []*Item, init func(*Item), assign func(*Item, *Hustler)) error {
	...
	query.withFKs = true
	query.Where(predicate.Hustler(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(item.HustlerWaistsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "item_hustler_waists" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (iq *ItemQuery) loadHustlerFeet(ctx context.Context, query *HustlerQuery, nodes []*Item, init func(*Item), assign func(*Item, *Hustler)) error {
	...
	query.withFKs = true
	query.Where(predicate.Hustler(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(item.HustlerFeetColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "item_hustler_feet" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (iq *ItemQuery) loadHustlerHands(ctx context.Context, query *HustlerQuery, nodes []*Item, init func(*Item), assign func(*Item, *Hustler)) error {
	...
	query.withFKs = true
	query.Where(predicate.Hustler(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(item.HustlerHandsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "item_hustler_hands" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (iq *ItemQuery) loadHustlerDrugs(ctx context.Context, query *HustlerQuery, nodes []*Item, init func(*Item), assign func(*Item, *Hustler)) error {
	...
	query.withFKs = true
	query.Where(predicate.Hustler(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(item.HustlerDrugsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "item_hustler_drugs" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (iq *ItemQuery) loadHustlerNecks(ctx context.Context, query *HustlerQuery, nodes []*Item, init func(*Item), assign func(*Item, *Hustler)) error {
	...
	query.withFKs = true
	query.Where(predicate.Hustler(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(item.HustlerNecksColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "item_hustler_necks" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (iq *ItemQuery) loadHustlerRings(ctx context.Context, query *HustlerQuery, nodes []*Item, init func(*Item), assign func(*Item, *Hustler)) error {
	...
	query.withFKs = true
	query.Where(predicate.Hustler(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(item.HustlerRingsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "item_hustler_rings" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (iq *ItemQuery) loadHustlerAccessories(ctx context.Context, query *HustlerQuery, nodes []*Item, init func(*Item), assign func(*Item, *Hustler)) error {
	...
	query.withFKs = true
	query.Where(predicate.Hustler(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(item.HustlerAccessoriesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "item_hustler_accessories" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (iq *ItemQuery) loadDerivative(ctx context.Context, query *ItemQuery, nodes []*Item, init func(*Item), assign func(*Item, *Item)) error {
	...
	query.Where(predicate.Item(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(item.DerivativeColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "item_derivative" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (iq *ItemQuery) loadIndex(ctx context.Context, query *SearchQuery, nodes []*Item, init func(*Item), assign func(*Item, *Search)) error {
	...
	query.Where(predicate.Search(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(item.IndexColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "item_index" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
