...
func (ic *ItemCreate) SetBestAskPriceEth(f float64) *ItemCreate {
	ic.mutation.SetBestAskPriceEth(f)
	return ic
}

// SetNillableBestAskPriceEth sets the "best_ask_price_eth" field if the given value is not nil.
func (ic *ItemCreate) SetNillableBestAskPriceEth(f *float64) *ItemCreate {
	if f != nil {
		ic.SetBestAskPriceEth(*f)
	}
	return ic
}
...
func (ic *ItemCreate) createSpec() (*Item, *sqlgraph.CreateSpec) {
	...
	if value, ok := ic.mutation.NamePrefix(); ok {
		_spec.SetField(item.FieldNamePrefix, field.TypeString, value)
		_node.NamePrefix = value
	}
	if value, ok := ic.mutation.NameSuffix(); ok {
		_spec.SetField(item.FieldNameSuffix, field.TypeString, value)
	...
	if value, ok := ic.mutation.Suffix(); ok {
		_spec.SetField(item.FieldSuffix, field.TypeString, value)
		_node.Suffix = value
	}
	if value, ok := ic.mutation.Augmented(); ok {
		_spec.SetField(item.FieldAugmented, field.TypeBool, value)
	...
	if value, ok := ic.mutation.BestAskPriceEth(); ok {
...
// SetBestAskPriceEth sets the "best_ask_price_eth" field.
func (u *ItemUpsert) SetBestAskPriceEth(v float64) *ItemUpsert {
	u.Set(item.FieldBestAskPriceEth, v)
	return u
}

// UpdateBestAskPriceEth sets the "best_ask_price_eth" field to the value that was provided on create.
func (u *ItemUpsert) UpdateBestAskPriceEth() *ItemUpsert {
	u.SetExcluded(item.FieldBestAskPriceEth)
	return u
}

// AddBestAskPriceEth adds v to the "best_ask_price_eth" field.
func (u *ItemUpsert) AddBestAskPriceEth(v float64) *ItemUpsert {
	u.Add(item.FieldBestAskPriceEth, v)
	return u
}

// ClearBestAskPriceEth clears the value of the "best_ask_price_eth" field.
func (u *ItemUpsert) ClearBestAskPriceEth() *ItemUpsert {
	u.SetNull(item.FieldBestAskPriceEth)
	return u
}
...
// SetBestAskPriceEth sets the "best_ask_price_eth" field.
func (u *ItemUpsertOne) SetBestAskPriceEth(v float64) *ItemUpsertOne {
	return u.Update(func(s *ItemUpsert) {
...
// AddBestAskPriceEth adds v to the "best_ask_price_eth" field.
func (u *ItemUpsertOne) AddBestAskPriceEth(v float64) *ItemUpsertOne {
	return u.Update(func(s *ItemUpsert) {
...
// UpdateBestAskPriceEth sets the "best_ask_price_eth" field to the value that was provided on create.
func (u *ItemUpsertOne) UpdateBestAskPriceEth() *ItemUpsertOne {
	return u.Update(func(s *ItemUpsert) {
...
// ClearBestAskPriceEth clears the value of the "best_ask_price_eth" field.
func (u *ItemUpsertOne) ClearBestAskPriceEth() *ItemUpsertOne {
	return u.Update(func(s *ItemUpsert) {
...
// SetBestAskPriceEth sets the "best_ask_price_eth" field.
func (u *ItemUpsertBulk) SetBestAskPriceEth(v float64) *ItemUpsertBulk {
	return u.Update(func(s *ItemUpsert) {
		s.SetBestAskPriceEth(v)
	})
}
...
// AddBestAskPriceEth adds v to the "best_ask_price_eth" field.
func (u *ItemUpsertBulk) AddBestAskPriceEth(v float64) *ItemUpsertBulk {
	return u.Update(func(s *ItemUpsert) {
		s.AddBestAskPriceEth(v)
	})
}
...
// UpdateBestAskPriceEth sets the "best_ask_price_eth" field to the value that was provided on create.
func (u *ItemUpsertBulk) UpdateBestAskPriceEth() *ItemUpsertBulk {
	return u.Update(func(s *ItemUpsert) {
		s.UpdateBestAskPriceEth()
	})
}
...
// ClearBestAskPriceEth clears the value of the "best_ask_price_eth" field.
func (u *ItemUpsertBulk) ClearBestAskPriceEth() *ItemUpsertBulk {
	return u.Update(func(s *ItemUpsert) {
		s.ClearBestAskPriceEth()
	})
}
