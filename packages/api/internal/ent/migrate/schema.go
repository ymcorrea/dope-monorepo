...
var (
	...
	DopesColumns = []*schema.Column{
		...
		{Name: "last_checked_paper_claim", Type: field.TypeTime, Nullable: true},
		{Name: "opened", Type: field.TypeBool, Default: false},
		{Name: "last_checked_gear_claim", Type: field.TypeTime, Nullable: true},
		{Name: "score", Type: field.TypeInt, Nullable: true},
		{Name: "rank", Type: field.TypeInt, Nullable: true},
		{Name: "order", Type: field.TypeInt},
		{Name: "best_ask_price_eth", Type: field.TypeFloat64, Nullable: true},
	...
	DopesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{DopesColumns[9]},
		...
		Indexes: []*schema.Index{
			{
				Name:    "dope_opened_best_ask_price_eth",
				Unique:  false,
				Columns: []*schema.Column{DopesColumns[3], DopesColumns[8]},
			},
		},
	}
	...
	HustlersTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{HustlersColumns[26]},
				RefColumns: []*schema.Column{WalletsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	WalletsColumns = []*schema.Column{
		...
		{Name: "last_set_paper_balance_at", Type: field.TypeTime, Nullable: true},
		{Name: "created_at", Type: field.TypeTime},
	}
