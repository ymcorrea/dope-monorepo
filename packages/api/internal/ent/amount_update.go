...
func (au *AmountUpdate) Save(ctx context.Context) (int, error) {
	return withHooks[int, AmountMutation](ctx, au.sqlSave, au.mutation, au.hooks)
}
...
func (au *AmountUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(amount.Table, amount.Columns, sqlgraph.NewFieldSpec(amount.FieldID, field.TypeString))
	...
	if value, ok := au.mutation.Amount(); ok {
		_spec.SetField(amount.FieldAmount, field.TypeInt, value)
	}
	if value, ok := au.mutation.AddedAmount(); ok {
		_spec.AddField(amount.FieldAmount, field.TypeInt, value)
	}
	if value, ok := au.mutation.AssetID(); ok {
		_spec.SetField(amount.FieldAssetID, field.TypeInt, value)
	}
	if value, ok := au.mutation.AddedAssetID(); ok {
		_spec.AddField(amount.FieldAssetID, field.TypeInt, value)
	}
...
// Where appends a list predicates to the AmountUpdate builder.
func (auo *AmountUpdateOne) Where(ps ...predicate.Amount) *AmountUpdateOne {
...
func (auo *AmountUpdateOne) Save(ctx context.Context) (*Amount, error) {
	return withHooks[*Amount, AmountMutation](ctx, auo.sqlSave, auo.mutation, auo.hooks)
}
