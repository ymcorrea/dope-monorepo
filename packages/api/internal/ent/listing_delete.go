...
func (ld *ListingDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, ListingMutation](ctx, ld.sqlExec, ld.mutation, ld.hooks)
}
...
func (ld *ListingDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(listing.Table, sqlgraph.NewFieldSpec(listing.FieldID, field.TypeString))
