...
func (f AmountFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AmountMutation); ok {
		return f(ctx, mv)
	}
...
func (f BodyPartFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.BodyPartMutation); ok {
		return f(ctx, mv)
	}
...
func (f DopeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DopeMutation); ok {
		return f(ctx, mv)
	}
...
func (f GameHustlerFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GameHustlerMutation); ok {
		return f(ctx, mv)
	}
...
func (f GameHustlerItemFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GameHustlerItemMutation); ok {
		return f(ctx, mv)
	}
...
func (f GameHustlerQuestFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GameHustlerQuestMutation); ok {
		return f(ctx, mv)
	}
...
func (f GameHustlerRelationFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GameHustlerRelationMutation); ok {
		return f(ctx, mv)
	}
...
func (f HustlerFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.HustlerMutation); ok {
		return f(ctx, mv)
	}
...
func (f SearchFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SearchMutation); ok {
		return f(ctx, mv)
	}
...
func (f WalletItemsFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.WalletItemsMutation); ok {
		return f(ctx, mv)
	}
