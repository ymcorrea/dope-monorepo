...
func (bpu *BodyPartUpdate) Save(ctx context.Context) (int, error) {
	return withHooks[int, BodyPartMutation](ctx, bpu.sqlSave, bpu.mutation, bpu.hooks)
}
...
func (bpu *BodyPartUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(bodypart.Table, bodypart.Columns, sqlgraph.NewFieldSpec(bodypart.FieldID, field.TypeString))
	...
	if value, ok := bpu.mutation.Sprite(); ok {
		_spec.SetField(bodypart.FieldSprite, field.TypeString, value)
	}
	if bpu.mutation.SpriteCleared() {
		_spec.ClearField(bodypart.FieldSprite, field.TypeString)
	}
...
// Where appends a list predicates to the BodyPartUpdate builder.
func (bpuo *BodyPartUpdateOne) Where(ps ...predicate.BodyPart) *BodyPartUpdateOne {
...
func (bpuo *BodyPartUpdateOne) Save(ctx context.Context) (*BodyPart, error) {
	return withHooks[*BodyPart, BodyPartMutation](ctx, bpuo.sqlSave, bpuo.mutation, bpuo.hooks)
}
