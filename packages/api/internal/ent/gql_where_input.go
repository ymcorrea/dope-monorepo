...
type AmountWhereInput struct {
	Predicates []predicate.Amount  `json:"-"`
...
func (i *AmountWhereInput) AddPredicates(predicates ...predicate.Amount) {
...
func (i *AmountWhereInput) Filter(q *AmountQuery) (*AmountQuery, error) {
	...
	p, err := i.P()
	if err != nil {
		if err == ErrEmptyAmountWhereInput {
			return q, nil
		}
		return nil, err
	}
...
// ErrEmptyAmountWhereInput is returned in case the AmountWhereInput is empty.
var ErrEmptyAmountWhereInput = errors.New("ent: empty predicate AmountWhereInput")
...
func (i *AmountWhereInput) P() (predicate.Amount, error) {
	...
	if i.IDEqualFold != nil {
		predicates = append(predicates, amount.IDEqualFold(*i.IDEqualFold))
	}
	if i.IDContainsFold != nil {
		predicates = append(predicates, amount.IDContainsFold(*i.IDContainsFold))
	}
	if i.Type != nil {
	...
	if len(i.HasListingInputWith) > 0 {
		...
		for _, w := range i.HasListingInputWith {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'HasListingInputWith'", err)
			}
			with = append(with, p)
		}
	...
	if len(i.HasListingOutputWith) > 0 {
		...
		for _, w := range i.HasListingOutputWith {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'HasListingOutputWith'", err)
			}
			with = append(with, p)
		}
	...
	case 0:
		return nil, ErrEmptyAmountWhereInput
	case 1:
...
func (i *DopeWhereInput) P() (predicate.Dope, error) {
	...
	if len(i.HasLastSaleWith) > 0 {
		...
		for _, w := range i.HasLastSaleWith {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'HasLastSaleWith'", err)
			}
			with = append(with, p)
		}
	...
	if len(i.HasListingsWith) > 0 {
		...
		for _, w := range i.HasListingsWith {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'HasListingsWith'", err)
			}
			with = append(with, p)
		}
...
type ListingWhereInput struct {
	Predicates []predicate.Listing  `json:"-"`
...
// AddPredicates adds custom predicates to the where input to be used during the filtering phase.
func (i *ListingWhereInput) AddPredicates(predicates ...predicate.Listing) {
	i.Predicates = append(i.Predicates, predicates...)
}
...
func (i *ListingWhereInput) Filter(q *ListingQuery) (*ListingQuery, error) {
	...
	p, err := i.P()
	if err != nil {
		if err == ErrEmptyListingWhereInput {
			return q, nil
		}
		return nil, err
	}
...
// ErrEmptyListingWhereInput is returned in case the ListingWhereInput is empty.
var ErrEmptyListingWhereInput = errors.New("ent: empty predicate ListingWhereInput")
...
func (i *ListingWhereInput) P() (predicate.Listing, error) {
	...
	if i.IDEqualFold != nil {
		predicates = append(predicates, listing.IDEqualFold(*i.IDEqualFold))
	}
	if i.IDContainsFold != nil {
		predicates = append(predicates, listing.IDContainsFold(*i.IDContainsFold))
	}
	if i.Active != nil {
	...
	if len(i.HasDopeLastsalesWith) > 0 {
		...
		for _, w := range i.HasDopeLastsalesWith {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'HasDopeLastsalesWith'", err)
			}
			with = append(with, p)
		}
	...
	if len(i.HasInputsWith) > 0 {
		...
		for _, w := range i.HasInputsWith {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'HasInputsWith'", err)
			}
			with = append(with, p)
		}
	...
	if len(i.HasOutputsWith) > 0 {
		...
		for _, w := range i.HasOutputsWith {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'HasOutputsWith'", err)
			}
			with = append(with, p)
		}
	...
	switch len(predicates) {
	case 0:
		return nil, ErrEmptyListingWhereInput
	case 1:
		return predicates[0], nil
	default:
