...
// OrderOption defines the ordering options for the Hustler queries.
...
// ByClothesField orders the results by clothes field.
func ByClothesField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newClothesStep(), sql.OrderByField(field, opts...))
	}
}
...
// ByWaistField orders the results by waist field.
func ByWaistField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newWaistStep(), sql.OrderByField(field, opts...))
	}
}

// ByFootField orders the results by foot field.
func ByFootField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newFootStep(), sql.OrderByField(field, opts...))
	}
}

// ByHandField orders the results by hand field.
func ByHandField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newHandStep(), sql.OrderByField(field, opts...))
	}
}
...
// ByNeckField orders the results by neck field.
func ByNeckField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newNeckStep(), sql.OrderByField(field, opts...))
	}
}

// ByRingField orders the results by ring field.
func ByRingField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newRingStep(), sql.OrderByField(field, opts...))
	}
}
...
// ByBodyField orders the results by body field.
func ByBodyField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newBodyStep(), sql.OrderByField(field, opts...))
	}
}

// ByHairField orders the results by hair field.
func ByHairField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newHairStep(), sql.OrderByField(field, opts...))
	}
}

// ByBeardField orders the results by beard field.
func ByBeardField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newBeardStep(), sql.OrderByField(field, opts...))
	}
}
...
func newWaistStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
...
func newFootStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
...
func newHandStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
...
func newNeckStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
...
func newRingStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
...
func newBodyStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
...
func newHairStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
...
func newBeardStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
