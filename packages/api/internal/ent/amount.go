...
func (*Amount) scanValues(columns []string) ([]any, error) {
...
func (a *Amount) assignValues(columns []string, values []any) error {
...
func (a *Amount) Update() *AmountUpdateOne {
	return NewAmountClient(a.config).UpdateOne(a)
}
