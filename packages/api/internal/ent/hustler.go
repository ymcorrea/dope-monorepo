...
func (*Hustler) scanValues(columns []string) ([]any, error) {
...
func (h *Hustler) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case hustler.FieldBestAskPriceEth:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				...
				h.BestAskPriceEth = value.Float64
			}
...
func (h *Hustler) Update() *HustlerUpdateOne {
	return NewHustlerClient(h.config).UpdateOne(h)
}
...
func (h *Hustler) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", h.BestAskPriceEth))
	builder.WriteByte(')')
