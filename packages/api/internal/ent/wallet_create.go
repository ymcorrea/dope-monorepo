...
func (wc *WalletCreate) SetLastSetPaperBalanceAt(t time.Time) *WalletCreate {
	wc.mutation.SetLastSetPaperBalanceAt(t)
	return wc
}

// SetNillableLastSetPaperBalanceAt sets the "last_set_paper_balance_at" field if the given value is not nil.
func (wc *WalletCreate) SetNillableLastSetPaperBalanceAt(t *time.Time) *WalletCreate {
	if t != nil {
		wc.SetLastSetPaperBalanceAt(*t)
	}
	return wc
}
...
func (wc *WalletCreate) createSpec() (*Wallet, *sqlgraph.CreateSpec) {
	...
	if value, ok := wc.mutation.Paper(); ok {
		_spec.SetField(wallet.FieldPaper, field.TypeInt, value)
		_node.Paper = value
	}
	if value, ok := wc.mutation.LastSetPaperBalanceAt(); ok {
		_spec.SetField(wallet.FieldLastSetPaperBalanceAt, field.TypeTime, value)
		_node.LastSetPaperBalanceAt = value
	}
...
// SetLastSetPaperBalanceAt sets the "last_set_paper_balance_at" field.
func (u *WalletUpsert) SetLastSetPaperBalanceAt(v time.Time) *WalletUpsert {
	u.Set(wallet.FieldLastSetPaperBalanceAt, v)
	return u
}

// UpdateLastSetPaperBalanceAt sets the "last_set_paper_balance_at" field to the value that was provided on create.
func (u *WalletUpsert) UpdateLastSetPaperBalanceAt() *WalletUpsert {
	u.SetExcluded(wallet.FieldLastSetPaperBalanceAt)
	return u
}

// ClearLastSetPaperBalanceAt clears the value of the "last_set_paper_balance_at" field.
func (u *WalletUpsert) ClearLastSetPaperBalanceAt() *WalletUpsert {
	u.SetNull(wallet.FieldLastSetPaperBalanceAt)
	return u
}
...
// SetLastSetPaperBalanceAt sets the "last_set_paper_balance_at" field.
func (u *WalletUpsertOne) SetLastSetPaperBalanceAt(v time.Time) *WalletUpsertOne {
	return u.Update(func(s *WalletUpsert) {
		s.SetLastSetPaperBalanceAt(v)
	})
}

// UpdateLastSetPaperBalanceAt sets the "last_set_paper_balance_at" field to the value that was provided on create.
func (u *WalletUpsertOne) UpdateLastSetPaperBalanceAt() *WalletUpsertOne {
	return u.Update(func(s *WalletUpsert) {
		s.UpdateLastSetPaperBalanceAt()
	})
}

// ClearLastSetPaperBalanceAt clears the value of the "last_set_paper_balance_at" field.
func (u *WalletUpsertOne) ClearLastSetPaperBalanceAt() *WalletUpsertOne {
	return u.Update(func(s *WalletUpsert) {
		s.ClearLastSetPaperBalanceAt()
	})
}
...
// SetLastSetPaperBalanceAt sets the "last_set_paper_balance_at" field.
func (u *WalletUpsertBulk) SetLastSetPaperBalanceAt(v time.Time) *WalletUpsertBulk {
	return u.Update(func(s *WalletUpsert) {
		s.SetLastSetPaperBalanceAt(v)
	})
}
...
// UpdateLastSetPaperBalanceAt sets the "last_set_paper_balance_at" field to the value that was provided on create.
func (u *WalletUpsertBulk) UpdateLastSetPaperBalanceAt() *WalletUpsertBulk {
	return u.Update(func(s *WalletUpsert) {
		s.UpdateLastSetPaperBalanceAt()
	})
}
...
// ClearLastSetPaperBalanceAt clears the value of the "last_set_paper_balance_at" field.
func (u *WalletUpsertBulk) ClearLastSetPaperBalanceAt() *WalletUpsertBulk {
	return u.Update(func(s *WalletUpsert) {
		s.ClearLastSetPaperBalanceAt()
	})
}
