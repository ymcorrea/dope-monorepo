...
func (iu *ItemUpdate) SetBestAskPriceEth(f float64) *ItemUpdate {
	iu.mutation.ResetBestAskPriceEth()
	iu.mutation.SetBestAskPriceEth(f)
	return iu
}

// SetNillableBestAskPriceEth sets the "best_ask_price_eth" field if the given value is not nil.
func (iu *ItemUpdate) SetNillableBestAskPriceEth(f *float64) *ItemUpdate {
	if f != nil {
		iu.SetBestAskPriceEth(*f)
	}
	return iu
}

// AddBestAskPriceEth adds f to the "best_ask_price_eth" field.
func (iu *ItemUpdate) AddBestAskPriceEth(f float64) *ItemUpdate {
	iu.mutation.AddBestAskPriceEth(f)
	return iu
}

// ClearBestAskPriceEth clears the value of the "best_ask_price_eth" field.
func (iu *ItemUpdate) ClearBestAskPriceEth() *ItemUpdate {
	iu.mutation.ClearBestAskPriceEth()
	return iu
}
...
func (iu *ItemUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if iu.mutation.NamePrefixCleared() {
		_spec.ClearField(item.FieldNamePrefix, field.TypeString)
	}
	if iu.mutation.NameSuffixCleared() {
		_spec.ClearField(item.FieldNameSuffix, field.TypeString)
	}
	if iu.mutation.SuffixCleared() {
		_spec.ClearField(item.FieldSuffix, field.TypeString)
	}
	if iu.mutation.AugmentedCleared() {
		_spec.ClearField(item.FieldAugmented, field.TypeBool)
	}
	...
	if iu.mutation.CountCleared() {
		_spec.ClearField(item.FieldCount, field.TypeInt)
	}
	if value, ok := iu.mutation.Tier(); ok {
		_spec.SetField(item.FieldTier, field.TypeEnum, value)
	}
	if iu.mutation.TierCleared() {
		_spec.ClearField(item.FieldTier, field.TypeEnum)
	}
	if value, ok := iu.mutation.Greatness(); ok {
		_spec.SetField(item.FieldGreatness, field.TypeInt, value)
	}
	if value, ok := iu.mutation.AddedGreatness(); ok {
		_spec.AddField(item.FieldGreatness, field.TypeInt, value)
	}
	if iu.mutation.GreatnessCleared() {
		_spec.ClearField(item.FieldGreatness, field.TypeInt)
	}
	if value, ok := iu.mutation.Rles(); ok {
		_spec.SetField(item.FieldRles, field.TypeJSON, value)
	}
	if iu.mutation.RlesCleared() {
		_spec.ClearField(item.FieldRles, field.TypeJSON)
	}
	if value, ok := iu.mutation.Svg(); ok {
		_spec.SetField(item.FieldSvg, field.TypeString, value)
	}
	if iu.mutation.SvgCleared() {
		_spec.ClearField(item.FieldSvg, field.TypeString)
	}
	if value, ok := iu.mutation.Sprite(); ok {
		_spec.SetField(item.FieldSprite, field.TypeJSON, value)
	}
	if iu.mutation.SpriteCleared() {
		_spec.ClearField(item.FieldSprite, field.TypeJSON)
	}
	if value, ok := iu.mutation.BestAskPriceEth(); ok {
		_spec.SetField(item.FieldBestAskPriceEth, field.TypeFloat64, value)
	}
	if value, ok := iu.mutation.AddedBestAskPriceEth(); ok {
		_spec.AddField(item.FieldBestAskPriceEth, field.TypeFloat64, value)
	}
	if iu.mutation.BestAskPriceEthCleared() {
		_spec.ClearField(item.FieldBestAskPriceEth, field.TypeFloat64)
	}
	if iu.mutation.WalletsCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(walletitems.FieldID, field.TypeString),
			},
		}
...
// SetBestAskPriceEth sets the "best_ask_price_eth" field.
func (iuo *ItemUpdateOne) SetBestAskPriceEth(f float64) *ItemUpdateOne {
	iuo.mutation.ResetBestAskPriceEth()
	iuo.mutation.SetBestAskPriceEth(f)
	return iuo
}

// SetNillableBestAskPriceEth sets the "best_ask_price_eth" field if the given value is not nil.
func (iuo *ItemUpdateOne) SetNillableBestAskPriceEth(f *float64) *ItemUpdateOne {
	if f != nil {
		iuo.SetBestAskPriceEth(*f)
	}
	return iuo
}

// AddBestAskPriceEth adds f to the "best_ask_price_eth" field.
func (iuo *ItemUpdateOne) AddBestAskPriceEth(f float64) *ItemUpdateOne {
	iuo.mutation.AddBestAskPriceEth(f)
	return iuo
}

// ClearBestAskPriceEth clears the value of the "best_ask_price_eth" field.
func (iuo *ItemUpdateOne) ClearBestAskPriceEth() *ItemUpdateOne {
	iuo.mutation.ClearBestAskPriceEth()
	return iuo
}
...
func (iuo *ItemUpdateOne) sqlSave(ctx context.Context) (_node *Item, err error) {
	...
	if value, ok := iuo.mutation.BestAskPriceEth(); ok {
		_spec.SetField(item.FieldBestAskPriceEth, field.TypeFloat64, value)
	}
	if value, ok := iuo.mutation.AddedBestAskPriceEth(); ok {
		_spec.AddField(item.FieldBestAskPriceEth, field.TypeFloat64, value)
	}
	if iuo.mutation.BestAskPriceEthCleared() {
		_spec.ClearField(item.FieldBestAskPriceEth, field.TypeFloat64)
	}
