...
func (wic *WalletItemsCreate) Save(ctx context.Context) (*WalletItems, error) {
	wic.defaults()
	return withHooks[*WalletItems, WalletItemsMutation](ctx, wic.sqlSave, wic.mutation, wic.hooks)
}
...
func (wic *WalletItemsCreate) createSpec() (*WalletItems, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(walletitems.Table, sqlgraph.NewFieldSpec(walletitems.FieldID, field.TypeString))
	)
