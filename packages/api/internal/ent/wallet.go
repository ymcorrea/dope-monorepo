...
type Wallet struct {
	...
	// LastSetPaperBalanceAt holds the value of the "last_set_paper_balance_at" field.
	LastSetPaperBalanceAt time.Time `json:"last_set_paper_balance_at,omitempty"`
...
func (*Wallet) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case wallet.FieldLastSetPaperBalanceAt, wallet.FieldCreatedAt:
	...
	for i := range columns {
		...
		case wallet.FieldLastSetPaperBalanceAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
				return fmt.Errorf("unexpected type %T for field last_set_paper_balance_at", values[i])
			} else if value.Valid {
				w.LastSetPaperBalanceAt = value.Time
			}
...
func (w *Wallet) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("last_set_paper_balance_at=")
	builder.WriteString(w.LastSetPaperBalanceAt.Format(time.ANSIC))
	builder.WriteString(", ")
