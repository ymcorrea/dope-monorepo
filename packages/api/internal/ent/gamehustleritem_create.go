...
func (ghic *GameHustlerItemCreate) Save(ctx context.Context) (*GameHustlerItem, error) {
	ghic.defaults()
	return withHooks[*GameHustlerItem, GameHustlerItemMutation](ctx, ghic.sqlSave, ghic.mutation, ghic.hooks)
}
...
func (ghic *GameHustlerItemCreate) sqlSave(ctx context.Context) (*GameHustlerItem, error) {
	...
	ghic.mutation.id = &_node.ID
	ghic.mutation.done = true
	return _node, nil
}
...
func (ghic *GameHustlerItemCreate) createSpec() (*GameHustlerItem, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(gamehustleritem.Table, sqlgraph.NewFieldSpec(gamehustleritem.FieldID, field.TypeString))
	)
