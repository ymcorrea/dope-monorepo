...
func (ghqc *GameHustlerQuestCreate) Save(ctx context.Context) (*GameHustlerQuest, error) {
	ghqc.defaults()
	return withHooks[*GameHustlerQuest, GameHustlerQuestMutation](ctx, ghqc.sqlSave, ghqc.mutation, ghqc.hooks)
}
...
func (ghqc *GameHustlerQuestCreate) sqlSave(ctx context.Context) (*GameHustlerQuest, error) {
	...
	ghqc.mutation.id = &_node.ID
	ghqc.mutation.done = true
	return _node, nil
}
...
func (ghqc *GameHustlerQuestCreate) createSpec() (*GameHustlerQuest, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(gamehustlerquest.Table, sqlgraph.NewFieldSpec(gamehustlerquest.FieldID, field.TypeString))
	)
