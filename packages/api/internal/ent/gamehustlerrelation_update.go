...
// SetNillableCitizen sets the "citizen" field if the given value is not nil.
func (ghru *GameHustlerRelationUpdate) SetNillableCitizen(s *string) *GameHustlerRelationUpdate {
	if s != nil {
		ghru.SetCitizen(*s)
	}
	return ghru
...
// SetNillableConversation sets the "conversation" field if the given value is not nil.
func (ghru *GameHustlerRelationUpdate) SetNillableConversation(s *string) *GameHustlerRelationUpdate {
	if s != nil {
		ghru.SetConversation(*s)
	}
	return ghru
}
...
func (ghru *GameHustlerRelationUpdate) SetNillableText(u *uint) *GameHustlerRelationUpdate {
	if u != nil {
		ghru.SetText(*u)
	}
	return ghru
...
func (ghru *GameHustlerRelationUpdate) Save(ctx context.Context) (int, error) {
	return withHooks(ctx, ghru.sqlSave, ghru.mutation, ghru.hooks)
}
...
// SetNillableCitizen sets the "citizen" field if the given value is not nil.
func (ghruo *GameHustlerRelationUpdateOne) SetNillableCitizen(s *string) *GameHustlerRelationUpdateOne {
	if s != nil {
		ghruo.SetCitizen(*s)
	}
	return ghruo
...
// SetNillableConversation sets the "conversation" field if the given value is not nil.
func (ghruo *GameHustlerRelationUpdateOne) SetNillableConversation(s *string) *GameHustlerRelationUpdateOne {
	if s != nil {
		ghruo.SetConversation(*s)
	}
	return ghruo
}
...
// SetNillableText sets the "text" field if the given value is not nil.
func (ghruo *GameHustlerRelationUpdateOne) SetNillableText(u *uint) *GameHustlerRelationUpdateOne {
	if u != nil {
		ghruo.SetText(*u)
	}
	return ghruo
...
func (ghruo *GameHustlerRelationUpdateOne) Save(ctx context.Context) (*GameHustlerRelation, error) {
	return withHooks(ctx, ghruo.sqlSave, ghruo.mutation, ghruo.hooks)
}
