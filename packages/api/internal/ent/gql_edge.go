...
func (bp *BodyPart) HustlerBodies(ctx context.Context) (result []*Hustler, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = bp.NamedHustlerBodies(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (bp *BodyPart) HustlerHairs(ctx context.Context) (result []*Hustler, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = bp.NamedHustlerHairs(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (bp *BodyPart) HustlerBeards(ctx context.Context) (result []*Hustler, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = bp.NamedHustlerBeards(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (d *Dope) Listings(ctx context.Context) (result []*Listing, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = d.NamedListings(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (d *Dope) Items(ctx context.Context) (result []*Item, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = d.NamedItems(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (gh *GameHustler) Relations(ctx context.Context) (result []*GameHustlerRelation, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = gh.NamedRelations(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (gh *GameHustler) Items(ctx context.Context) (result []*GameHustlerItem, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = gh.NamedItems(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (gh *GameHustler) Quests(ctx context.Context) (result []*GameHustlerQuest, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = gh.NamedQuests(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (i *Item) Wallets(ctx context.Context) (result []*WalletItems, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = i.NamedWallets(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (i *Item) Dopes(ctx context.Context) (result []*Dope, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = i.NamedDopes(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (i *Item) HustlerWeapons(ctx context.Context) (result []*Hustler, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = i.NamedHustlerWeapons(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (i *Item) HustlerClothes(ctx context.Context) (result []*Hustler, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = i.NamedHustlerClothes(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (i *Item) HustlerVehicles(ctx context.Context) (result []*Hustler, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = i.NamedHustlerVehicles(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (i *Item) HustlerWaists(ctx context.Context) (result []*Hustler, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = i.NamedHustlerWaists(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (i *Item) HustlerFeet(ctx context.Context) (result []*Hustler, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = i.NamedHustlerFeet(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (i *Item) HustlerHands(ctx context.Context) (result []*Hustler, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = i.NamedHustlerHands(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (i *Item) HustlerDrugs(ctx context.Context) (result []*Hustler, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = i.NamedHustlerDrugs(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (i *Item) HustlerNecks(ctx context.Context) (result []*Hustler, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = i.NamedHustlerNecks(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (i *Item) HustlerRings(ctx context.Context) (result []*Hustler, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = i.NamedHustlerRings(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (i *Item) HustlerAccessories(ctx context.Context) (result []*Hustler, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = i.NamedHustlerAccessories(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (i *Item) Derivative(ctx context.Context) (result []*Item, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = i.NamedDerivative(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (l *Listing) Inputs(ctx context.Context) (result []*Amount, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = l.NamedInputs(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (l *Listing) Outputs(ctx context.Context) (result []*Amount, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = l.NamedOutputs(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (w *Wallet) Dopes(ctx context.Context) (result []*Dope, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = w.NamedDopes(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (w *Wallet) Items(ctx context.Context) (result []*WalletItems, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = w.NamedItems(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (w *Wallet) Hustlers(ctx context.Context) (result []*Hustler, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = w.NamedHustlers(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
