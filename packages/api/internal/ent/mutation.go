...
// WhereP appends storage-level predicates to the BodyPartMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *BodyPartMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.BodyPart, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
func (m *BodyPartMutation) SetOp(op Op) {
	m.op = op
}
...
type DopeMutation struct {
	...
	id                       *string
	claimed                  *bool
	last_checked_paper_claim *time.Time
	opened                   *bool
	last_checked_gear_claim  *time.Time
	score                    *int
	addscore                 *int
	rank                     *int
	addrank                  *int
	_order                   *int
	add_order                *int
	best_ask_price_eth       *float64
	addbest_ask_price_eth    *float64
	clearedFields            map[string]struct{}
	wallet                   *string
	clearedwallet            bool
...
func (m *DopeMutation) SetLastCheckedPaperClaim(t time.Time) {
	m.last_checked_paper_claim = &t
}

// LastCheckedPaperClaim returns the value of the "last_checked_paper_claim" field in the mutation.
func (m *DopeMutation) LastCheckedPaperClaim() (r time.Time, exists bool) {
	v := m.last_checked_paper_claim
	if v == nil {
		return
	}
	return *v, true
...
// OldLastCheckedPaperClaim returns the old "last_checked_paper_claim" field's value of the Dope entity.
// If the Dope object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *DopeMutation) OldLastCheckedPaperClaim(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldLastCheckedPaperClaim is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldLastCheckedPaperClaim requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldLastCheckedPaperClaim: %w", err)
	}
	return oldValue.LastCheckedPaperClaim, nil
}

// ClearLastCheckedPaperClaim clears the value of the "last_checked_paper_claim" field.
func (m *DopeMutation) ClearLastCheckedPaperClaim() {
	m.last_checked_paper_claim = nil
	m.clearedFields[dope.FieldLastCheckedPaperClaim] = struct{}{}
}

// LastCheckedPaperClaimCleared returns if the "last_checked_paper_claim" field was cleared in this mutation.
func (m *DopeMutation) LastCheckedPaperClaimCleared() bool {
	_, ok := m.clearedFields[dope.FieldLastCheckedPaperClaim]
	return ok
}

// ResetLastCheckedPaperClaim resets all changes to the "last_checked_paper_claim" field.
func (m *DopeMutation) ResetLastCheckedPaperClaim() {
	m.last_checked_paper_claim = nil
	delete(m.clearedFields, dope.FieldLastCheckedPaperClaim)
}
...
func (m *DopeMutation) SetLastCheckedGearClaim(t time.Time) {
	m.last_checked_gear_claim = &t
}

// LastCheckedGearClaim returns the value of the "last_checked_gear_claim" field in the mutation.
func (m *DopeMutation) LastCheckedGearClaim() (r time.Time, exists bool) {
	v := m.last_checked_gear_claim
	if v == nil {
		return
	}
	return *v, true
...
// OldLastCheckedGearClaim returns the old "last_checked_gear_claim" field's value of the Dope entity.
// If the Dope object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *DopeMutation) OldLastCheckedGearClaim(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldLastCheckedGearClaim is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldLastCheckedGearClaim requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldLastCheckedGearClaim: %w", err)
	}
	return oldValue.LastCheckedGearClaim, nil
}

// ClearLastCheckedGearClaim clears the value of the "last_checked_gear_claim" field.
func (m *DopeMutation) ClearLastCheckedGearClaim() {
	m.last_checked_gear_claim = nil
	m.clearedFields[dope.FieldLastCheckedGearClaim] = struct{}{}
}

// LastCheckedGearClaimCleared returns if the "last_checked_gear_claim" field was cleared in this mutation.
func (m *DopeMutation) LastCheckedGearClaimCleared() bool {
	_, ok := m.clearedFields[dope.FieldLastCheckedGearClaim]
	return ok
}

// ResetLastCheckedGearClaim resets all changes to the "last_checked_gear_claim" field.
func (m *DopeMutation) ResetLastCheckedGearClaim() {
	m.last_checked_gear_claim = nil
	delete(m.clearedFields, dope.FieldLastCheckedGearClaim)
}
...
func (m *DopeMutation) SetBestAskPriceEth(f float64) {
	m.best_ask_price_eth = &f
	m.addbest_ask_price_eth = nil
}

// BestAskPriceEth returns the value of the "best_ask_price_eth" field in the mutation.
func (m *DopeMutation) BestAskPriceEth() (r float64, exists bool) {
	v := m.best_ask_price_eth
	if v == nil {
		return
	}
	return *v, true
...
// OldBestAskPriceEth returns the old "best_ask_price_eth" field's value of the Dope entity.
// If the Dope object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *DopeMutation) OldBestAskPriceEth(ctx context.Context) (v float64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldBestAskPriceEth is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldBestAskPriceEth requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldBestAskPriceEth: %w", err)
	}
	return oldValue.BestAskPriceEth, nil
}

// AddBestAskPriceEth adds f to the "best_ask_price_eth" field.
func (m *DopeMutation) AddBestAskPriceEth(f float64) {
	if m.addbest_ask_price_eth != nil {
		*m.addbest_ask_price_eth += f
	} else {
		m.addbest_ask_price_eth = &f
	}
}

// AddedBestAskPriceEth returns the value that was added to the "best_ask_price_eth" field in this mutation.
func (m *DopeMutation) AddedBestAskPriceEth() (r float64, exists bool) {
	v := m.addbest_ask_price_eth
	if v == nil {
		return
	}
	return *v, true
...
func (m *DopeMutation) ClearBestAskPriceEth() {
	m.best_ask_price_eth = nil
	m.addbest_ask_price_eth = nil
	m.clearedFields[dope.FieldBestAskPriceEth] = struct{}{}
}

// BestAskPriceEthCleared returns if the "best_ask_price_eth" field was cleared in this mutation.
func (m *DopeMutation) BestAskPriceEthCleared() bool {
	_, ok := m.clearedFields[dope.FieldBestAskPriceEth]
	return ok
}

// ResetBestAskPriceEth resets all changes to the "best_ask_price_eth" field.
func (m *DopeMutation) ResetBestAskPriceEth() {
	m.best_ask_price_eth = nil
	m.addbest_ask_price_eth = nil
	delete(m.clearedFields, dope.FieldBestAskPriceEth)
}
...
// WhereP appends storage-level predicates to the DopeMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *DopeMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.Dope, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *DopeMutation) SetOp(op Op) {
	m.op = op
}
...
func (m *DopeMutation) Fields() []string {
	...
	if m.last_checked_paper_claim != nil {
		fields = append(fields, dope.FieldLastCheckedPaperClaim)
	}
	if m.opened != nil {
		fields = append(fields, dope.FieldOpened)
	}
	if m.last_checked_gear_claim != nil {
		fields = append(fields, dope.FieldLastCheckedGearClaim)
	}
	if m.score != nil {
	...
	if m.best_ask_price_eth != nil {
		fields = append(fields, dope.FieldBestAskPriceEth)
	}
	return fields
}
...
func (m *DopeMutation) Field(name string) (ent.Value, bool) {
	...
	case dope.FieldLastCheckedPaperClaim:
		return m.LastCheckedPaperClaim()
	case dope.FieldOpened:
		return m.Opened()
	case dope.FieldLastCheckedGearClaim:
		return m.LastCheckedGearClaim()
...
func (m *DopeMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	case dope.FieldLastCheckedPaperClaim:
		return m.OldLastCheckedPaperClaim(ctx)
	case dope.FieldOpened:
		return m.OldOpened(ctx)
	case dope.FieldLastCheckedGearClaim:
		return m.OldLastCheckedGearClaim(ctx)
	case dope.FieldScore:
	...
	case dope.FieldBestAskPriceEth:
		return m.OldBestAskPriceEth(ctx)
	}
...
func (m *DopeMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(dope.FieldLastCheckedPaperClaim) {
		fields = append(fields, dope.FieldLastCheckedPaperClaim)
	}
	if m.FieldCleared(dope.FieldLastCheckedGearClaim) {
		fields = append(fields, dope.FieldLastCheckedGearClaim)
	}
	...
	if m.FieldCleared(dope.FieldBestAskPriceEth) {
		fields = append(fields, dope.FieldBestAskPriceEth)
	}
	return fields
}
...
func (m *DopeMutation) ClearField(name string) error {
	switch name {
	case dope.FieldLastCheckedPaperClaim:
		m.ClearLastCheckedPaperClaim()
		return nil
	case dope.FieldLastCheckedGearClaim:
		m.ClearLastCheckedGearClaim()
		return nil
	case dope.FieldScore:
		m.ClearScore()
		return nil
...
func (m *DopeMutation) ResetField(name string) error {
	...
	case dope.FieldClaimed:
		...
		return nil
	case dope.FieldLastCheckedPaperClaim:
		m.ResetLastCheckedPaperClaim()
		return nil
	case dope.FieldOpened:
		m.ResetOpened()
		return nil
	case dope.FieldLastCheckedGearClaim:
		m.ResetLastCheckedGearClaim()
		return nil
	case dope.FieldScore:
		m.ResetScore()
		return nil
...
// WhereP appends storage-level predicates to the GameHustlerMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *GameHustlerMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.GameHustler, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *GameHustlerMutation) SetOp(op Op) {
	m.op = op
}
...
// WhereP appends storage-level predicates to the GameHustlerItemMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *GameHustlerItemMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.GameHustlerItem, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *GameHustlerItemMutation) SetOp(op Op) {
	m.op = op
}
...
// WhereP appends storage-level predicates to the GameHustlerQuestMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *GameHustlerQuestMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.GameHustlerQuest, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *GameHustlerQuestMutation) SetOp(op Op) {
	m.op = op
}
...
// WhereP appends storage-level predicates to the GameHustlerRelationMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *GameHustlerRelationMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.GameHustlerRelation, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *GameHustlerRelationMutation) SetOp(op Op) {
	m.op = op
}
...
// AppendViewbox adds i to the "viewbox" field.
func (m *HustlerMutation) AppendViewbox(i []int) {
	m.appendviewbox = append(m.appendviewbox, i...)
}

// AppendedViewbox returns the list of values that were appended to the "viewbox" field in this mutation.
func (m *HustlerMutation) AppendedViewbox() ([]int, bool) {
	if len(m.appendviewbox) == 0 {
		return nil, false
	}
	return m.appendviewbox, true
}
...
// AppendOrder adds i to the "order" field.
func (m *HustlerMutation) AppendOrder(i []int) {
	m.append_order = append(m.append_order, i...)
}

// AppendedOrder returns the list of values that were appended to the "order" field in this mutation.
func (m *HustlerMutation) AppendedOrder() ([]int, bool) {
	if len(m.append_order) == 0 {
		return nil, false
	}
	return m.append_order, true
}
...
// SetBestAskPriceEth sets the "best_ask_price_eth" field.
func (m *HustlerMutation) SetBestAskPriceEth(f float64) {
	m.best_ask_price_eth = &f
	m.addbest_ask_price_eth = nil
}

// BestAskPriceEth returns the value of the "best_ask_price_eth" field in the mutation.
func (m *HustlerMutation) BestAskPriceEth() (r float64, exists bool) {
	v := m.best_ask_price_eth
	if v == nil {
		return
	}
...
// OldBestAskPriceEth returns the old "best_ask_price_eth" field's value of the Hustler entity.
// If the Hustler object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HustlerMutation) OldBestAskPriceEth(ctx context.Context) (v float64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldBestAskPriceEth is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddBestAskPriceEth adds f to the "best_ask_price_eth" field.
func (m *HustlerMutation) AddBestAskPriceEth(f float64) {
	if m.addbest_ask_price_eth != nil {
		*m.addbest_ask_price_eth += f
	} else {
		m.addbest_ask_price_eth = &f
...
// AddedBestAskPriceEth returns the value that was added to the "best_ask_price_eth" field in this mutation.
func (m *HustlerMutation) AddedBestAskPriceEth() (r float64, exists bool) {
	v := m.addbest_ask_price_eth
	if v == nil {
		return
	}
...
// ClearBestAskPriceEth clears the value of the "best_ask_price_eth" field.
func (m *HustlerMutation) ClearBestAskPriceEth() {
	m.best_ask_price_eth = nil
	m.addbest_ask_price_eth = nil
	m.clearedFields[hustler.FieldBestAskPriceEth] = struct{}{}
}

// BestAskPriceEthCleared returns if the "best_ask_price_eth" field was cleared in this mutation.
func (m *HustlerMutation) BestAskPriceEthCleared() bool {
	_, ok := m.clearedFields[hustler.FieldBestAskPriceEth]
	return ok
}

// ResetBestAskPriceEth resets all changes to the "best_ask_price_eth" field.
func (m *HustlerMutation) ResetBestAskPriceEth() {
	m.best_ask_price_eth = nil
	m.addbest_ask_price_eth = nil
	delete(m.clearedFields, hustler.FieldBestAskPriceEth)
}
...
// WhereP appends storage-level predicates to the HustlerMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *HustlerMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.Hustler, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *HustlerMutation) SetOp(op Op) {
	m.op = op
}
...
func (m *HustlerMutation) Fields() []string {
	...
	if m.best_ask_price_eth != nil {
		fields = append(fields, hustler.FieldBestAskPriceEth)
	}
	return fields
}
...
func (m *HustlerMutation) Field(name string) (ent.Value, bool) {
	...
	case hustler.FieldCreatedAt:
		return m.CreatedAt()
	case hustler.FieldBestAskPriceEth:
		return m.BestAskPriceEth()
	}
	return nil, false
}
...
func (m *HustlerMutation) ClearedFields() []string {
	...
	if m.FieldCleared(hustler.FieldBestAskPriceEth) {
		fields = append(fields, hustler.FieldBestAskPriceEth)
	}
	return fields
}
...
// SetBestAskPriceEth sets the "best_ask_price_eth" field.
func (m *ItemMutation) SetBestAskPriceEth(f float64) {
	m.best_ask_price_eth = &f
	m.addbest_ask_price_eth = nil
}

// BestAskPriceEth returns the value of the "best_ask_price_eth" field in the mutation.
func (m *ItemMutation) BestAskPriceEth() (r float64, exists bool) {
	v := m.best_ask_price_eth
	if v == nil {
		return
	}
...
// OldBestAskPriceEth returns the old "best_ask_price_eth" field's value of the Item entity.
// If the Item object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ItemMutation) OldBestAskPriceEth(ctx context.Context) (v float64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldBestAskPriceEth is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddBestAskPriceEth adds f to the "best_ask_price_eth" field.
func (m *ItemMutation) AddBestAskPriceEth(f float64) {
	if m.addbest_ask_price_eth != nil {
		*m.addbest_ask_price_eth += f
	} else {
		m.addbest_ask_price_eth = &f
...
// AddedBestAskPriceEth returns the value that was added to the "best_ask_price_eth" field in this mutation.
func (m *ItemMutation) AddedBestAskPriceEth() (r float64, exists bool) {
	v := m.addbest_ask_price_eth
	if v == nil {
		return
	}
...
// ClearBestAskPriceEth clears the value of the "best_ask_price_eth" field.
func (m *ItemMutation) ClearBestAskPriceEth() {
	m.best_ask_price_eth = nil
	m.addbest_ask_price_eth = nil
	m.clearedFields[item.FieldBestAskPriceEth] = struct{}{}
}

// BestAskPriceEthCleared returns if the "best_ask_price_eth" field was cleared in this mutation.
func (m *ItemMutation) BestAskPriceEthCleared() bool {
	_, ok := m.clearedFields[item.FieldBestAskPriceEth]
	return ok
}

// ResetBestAskPriceEth resets all changes to the "best_ask_price_eth" field.
func (m *ItemMutation) ResetBestAskPriceEth() {
	m.best_ask_price_eth = nil
	m.addbest_ask_price_eth = nil
	delete(m.clearedFields, item.FieldBestAskPriceEth)
}
...
func (m *ItemMutation) Fields() []string {
	...
	if m.best_ask_price_eth != nil {
		fields = append(fields, item.FieldBestAskPriceEth)
	}
	return fields
}
...
func (m *ItemMutation) Field(name string) (ent.Value, bool) {
	...
	case item.FieldSprite:
		return m.Sprite()
	case item.FieldBestAskPriceEth:
		return m.BestAskPriceEth()
	}
	return nil, false
}
...
func (m *ItemMutation) ClearedFields() []string {
	...
	if m.FieldCleared(item.FieldBestAskPriceEth) {
		fields = append(fields, item.FieldBestAskPriceEth)
	}
	return fields
}
...
func (m *SearchMutation) SetBanned(b bool) {
	m.banned = &b
}

// Banned returns the value of the "banned" field in the mutation.
func (m *SearchMutation) Banned() (r bool, exists bool) {
	v := m.banned
	if v == nil {
		return
	}
...
// OldBanned returns the old "banned" field's value of the Search entity.
// If the Search object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SearchMutation) OldBanned(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SearchMutation) ResetBanned() {
	m.banned = nil
}

// SetSalePrice sets the "sale_price" field.
func (m *SearchMutation) SetSalePrice(f float64) {
	m.sale_price = &f
	m.addsale_price = nil
}

// SalePrice returns the value of the "sale_price" field in the mutation.
func (m *SearchMutation) SalePrice() (r float64, exists bool) {
	v := m.sale_price
	if v == nil {
		return
	}
...
// If the Search object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SearchMutation) OldSalePrice(ctx context.Context) (v float64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SearchMutation) AddSalePrice(f float64) {
...
func (m *SearchMutation) AddedSalePrice() (r float64, exists bool) {
	v := m.addsale_price
	if v == nil {
		return
	}
...
func (m *SearchMutation) ClearSalePrice() {
	m.sale_price = nil
	m.addsale_price = nil
	m.clearedFields[search.FieldSalePrice] = struct{}{}
}

// SalePriceCleared returns if the "sale_price" field was cleared in this mutation.
func (m *SearchMutation) SalePriceCleared() bool {
	_, ok := m.clearedFields[search.FieldSalePrice]
	return ok
}
...
func (m *SearchMutation) ResetSalePrice() {
	m.sale_price = nil
	m.addsale_price = nil
	delete(m.clearedFields, search.FieldSalePrice)
}
...
// WhereP appends storage-level predicates to the SearchMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *SearchMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.Search, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *SearchMutation) SetOp(op Op) {
	m.op = op
}
...
func (m *SearchMutation) Fields() []string {
	...
	if m.banned != nil {
		fields = append(fields, search.FieldBanned)
	}
	if m.sale_price != nil {
...
func (m *SearchMutation) ClearedFields() []string {
	...
	if m.FieldCleared(search.FieldSalePrice) {
		fields = append(fields, search.FieldSalePrice)
	}
	return fields
}
...
func (m *SyncStateMutation) SetContractName(s string) {
	m.contract_name = &s
}

// ContractName returns the value of the "contract_name" field in the mutation.
func (m *SyncStateMutation) ContractName() (r string, exists bool) {
	v := m.contract_name
	if v == nil {
		return
	}
...
// OldContractName returns the old "contract_name" field's value of the SyncState entity.
// If the SyncState object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SyncStateMutation) OldContractName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SyncStateMutation) ClearContractName() {
	m.contract_name = nil
	m.clearedFields[syncstate.FieldContractName] = struct{}{}
}

// ContractNameCleared returns if the "contract_name" field was cleared in this mutation.
func (m *SyncStateMutation) ContractNameCleared() bool {
	_, ok := m.clearedFields[syncstate.FieldContractName]
	return ok
}

// ResetContractName resets all changes to the "contract_name" field.
func (m *SyncStateMutation) ResetContractName() {
	m.contract_name = nil
	delete(m.clearedFields, syncstate.FieldContractName)
}
...
func (m *SyncStateMutation) SetBlockTime(t time.Time) {
	m.block_time = &t
}

// BlockTime returns the value of the "block_time" field in the mutation.
func (m *SyncStateMutation) BlockTime() (r time.Time, exists bool) {
	v := m.block_time
	if v == nil {
		return
	}
...
// OldBlockTime returns the old "block_time" field's value of the SyncState entity.
// If the SyncState object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SyncStateMutation) OldBlockTime(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SyncStateMutation) ClearBlockTime() {
	m.block_time = nil
	m.clearedFields[syncstate.FieldBlockTime] = struct{}{}
}

// BlockTimeCleared returns if the "block_time" field was cleared in this mutation.
func (m *SyncStateMutation) BlockTimeCleared() bool {
	_, ok := m.clearedFields[syncstate.FieldBlockTime]
	return ok
}

// ResetBlockTime resets all changes to the "block_time" field.
func (m *SyncStateMutation) ResetBlockTime() {
	m.block_time = nil
	delete(m.clearedFields, syncstate.FieldBlockTime)
}
...
func (m *SyncStateMutation) Fields() []string {
	...
	if m.contract_name != nil {
		fields = append(fields, syncstate.FieldContractName)
	}
	if m.start_block != nil {
		fields = append(fields, syncstate.FieldStartBlock)
	}
	if m.block_time != nil {
		fields = append(fields, syncstate.FieldBlockTime)
	}
...
func (m *SyncStateMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(syncstate.FieldContractName) {
		fields = append(fields, syncstate.FieldContractName)
	}
	if m.FieldCleared(syncstate.FieldBlockTime) {
		fields = append(fields, syncstate.FieldBlockTime)
	}
...
type WalletMutation struct {
	...
	last_set_paper_balance_at *time.Time
	created_at                *time.Time
	clearedFields             map[string]struct{}
	dopes                     map[string]struct{}
	removeddopes              map[string]struct{}
...
// SetLastSetPaperBalanceAt sets the "last_set_paper_balance_at" field.
func (m *WalletMutation) SetLastSetPaperBalanceAt(t time.Time) {
	m.last_set_paper_balance_at = &t
}

// LastSetPaperBalanceAt returns the value of the "last_set_paper_balance_at" field in the mutation.
func (m *WalletMutation) LastSetPaperBalanceAt() (r time.Time, exists bool) {
	v := m.last_set_paper_balance_at
	if v == nil {
		return
	}
	return *v, true
...
// OldLastSetPaperBalanceAt returns the old "last_set_paper_balance_at" field's value of the Wallet entity.
// If the Wallet object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *WalletMutation) OldLastSetPaperBalanceAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldLastSetPaperBalanceAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldLastSetPaperBalanceAt requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldLastSetPaperBalanceAt: %w", err)
	}
	return oldValue.LastSetPaperBalanceAt, nil
}

// ClearLastSetPaperBalanceAt clears the value of the "last_set_paper_balance_at" field.
func (m *WalletMutation) ClearLastSetPaperBalanceAt() {
	m.last_set_paper_balance_at = nil
	m.clearedFields[wallet.FieldLastSetPaperBalanceAt] = struct{}{}
}

// LastSetPaperBalanceAtCleared returns if the "last_set_paper_balance_at" field was cleared in this mutation.
func (m *WalletMutation) LastSetPaperBalanceAtCleared() bool {
	_, ok := m.clearedFields[wallet.FieldLastSetPaperBalanceAt]
	return ok
}

// ResetLastSetPaperBalanceAt resets all changes to the "last_set_paper_balance_at" field.
func (m *WalletMutation) ResetLastSetPaperBalanceAt() {
	m.last_set_paper_balance_at = nil
	delete(m.clearedFields, wallet.FieldLastSetPaperBalanceAt)
}
...
func (m *WalletMutation) Fields() []string {
	...
	if m.last_set_paper_balance_at != nil {
		fields = append(fields, wallet.FieldLastSetPaperBalanceAt)
	}
	if m.created_at != nil {
...
func (m *WalletMutation) Field(name string) (ent.Value, bool) {
	...
	case wallet.FieldPaper:
		return m.Paper()
	case wallet.FieldLastSetPaperBalanceAt:
		return m.LastSetPaperBalanceAt()
...
func (m *WalletMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	case wallet.FieldLastSetPaperBalanceAt:
		return m.OldLastSetPaperBalanceAt(ctx)
	case wallet.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	}
...
func (m *WalletMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(wallet.FieldLastSetPaperBalanceAt) {
		fields = append(fields, wallet.FieldLastSetPaperBalanceAt)
	}
	return fields
}
...
// WhereP appends storage-level predicates to the WalletItemsMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *WalletItemsMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.WalletItems, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *WalletItemsMutation) SetOp(op Op) {
	m.op = op
}
