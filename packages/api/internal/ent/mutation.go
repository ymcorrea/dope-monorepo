...
// WhereP appends storage-level predicates to the AmountMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *AmountMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.Amount, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
func (m *AmountMutation) SetOp(op Op) {
	m.op = op
}
...
type ListingMutation struct {
	...
	appendwyvern_order    json.RawMessage
	seaport_order         *json.RawMessage
	appendseaport_order   json.RawMessage
	clearedFields         map[string]struct{}
	dope                  *string
	cleareddope           bool
...
// AppendWyvernOrder adds jm to the "wyvern_order" field.
func (m *ListingMutation) AppendWyvernOrder(jm json.RawMessage) {
	m.appendwyvern_order = append(m.appendwyvern_order, jm...)
}

// AppendedWyvernOrder returns the list of values that were appended to the "wyvern_order" field in this mutation.
func (m *ListingMutation) AppendedWyvernOrder() (json.RawMessage, bool) {
	if len(m.appendwyvern_order) == 0 {
		return nil, false
	}
	return m.appendwyvern_order, true
}
...
// AppendSeaportOrder adds jm to the "seaport_order" field.
func (m *ListingMutation) AppendSeaportOrder(jm json.RawMessage) {
	m.appendseaport_order = append(m.appendseaport_order, jm...)
}

// AppendedSeaportOrder returns the list of values that were appended to the "seaport_order" field in this mutation.
func (m *ListingMutation) AppendedSeaportOrder() (json.RawMessage, bool) {
	if len(m.appendseaport_order) == 0 {
		return nil, false
	}
	return m.appendseaport_order, true
}
