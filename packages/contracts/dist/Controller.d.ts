...
export interface ControllerInterface extends Interface {
    getFunction(nameOrSignature: "addAccessory" | "addBodyRles" | "addItemComponent" | "batchSetItemRle" | "dao" | "initiator" | "maintainer" | "mintItem" | "mintItemBatch" | "mintOGTo" | "mintTo" | "onERC1155BatchReceived" | "onERC1155Received" | "open" | "setDAO" | "setEnforcer" | "setInitiator" | "setItemRle" | "setMaintainer" | "setPalette" | "supportsInterface"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "mintItemBatch", values: [
        AddressLike,
        BigNumberish[],
        BigNumberish[],
        BigNumberish[],
    ...
    encodeFunctionData(functionFragment: "setInitiator", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "setItemRle", values: [BigNumberish, BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "setMaintainer", values: [AddressLike]): string;
...
export interface Controller extends BaseContract {
    ...
    getFunction(nameOrSignature: "addAccessory"): TypedContractMethod<[component: string], [void], "nonpayable">;
    getFunction(nameOrSignature: "addBodyRles"): TypedContractMethod<[
        part: BigNumberish,
        _rles: BytesLike[]
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "addItemComponent"): TypedContractMethod<[
        componentType: BigNumberish,
        component: string
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "batchSetItemRle"): TypedContractMethod<[
        ids: BigNumberish[],
        rles: BytesLike[]
    ], [
        void
    ...
    getFunction(nameOrSignature: "initiator"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "mintItemBatch"): TypedContractMethod<[
        to: AddressLike,
        components_: BigNumberish[],
        componentTypes: BigNumberish[],
        amounts: BigNumberish[],
    ...
    getFunction(nameOrSignature: "setDAO"): TypedContractMethod<[dao_: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "setEnforcer"): TypedContractMethod<[enforcer_: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "setInitiator"): TypedContractMethod<[initiator_: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "setItemRle"): TypedContractMethod<[
        id: BigNumberish,
        male: BytesLike,
        female: BytesLike
    ], [
    ...
    getFunction(nameOrSignature: "setMaintainer"): TypedContractMethod<[maintainer_: AddressLike], [void], "nonpayable">;
