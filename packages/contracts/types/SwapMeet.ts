...
export interface SwapMeet extends BaseContract {
  ...
  open: TypedContractMethod<
    [id: BigNumberish, to: AddressLike, data: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  tokenRle: TypedContractMethod<
    [id: BigNumberish, gender: BigNumberish],
    [string],
    "view"
  >;
  ...
  getEvent(
    ...
    SetRleEvent.InputTuple,
    SetRleEvent.OutputTuple,
    SetRleEvent.OutputObject
  >;
  getEvent(
    key: "TransferBatch"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "SetRle(uint256)": TypedContractEvent<
      SetRleEvent.InputTuple,
      SetRleEvent.OutputTuple,
      SetRleEvent.OutputObject
    >;
    SetRle: TypedContractEvent<
      SetRleEvent.InputTuple,
      SetRleEvent.OutputTuple,
      SetRleEvent.OutputObject
    >;
