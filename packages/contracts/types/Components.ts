...
export interface ComponentsInterface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "AddComponent" | "OwnershipTransferred"
  ): EventFragment;
...
export namespace AddComponentEvent {
...
export interface Components extends BaseContract {
  ...
  name: TypedContractMethod<
    [componentType: BigNumberish, idx: BigNumberish],
    [string],
    "view"
  >;
  ...
  prefix: TypedContractMethod<
    [prefixComponent: BigNumberish, suffixComponent: BigNumberish],
    [string],
    "view"
  >;
  ...
  seed: TypedContractMethod<
    [tokenId: BigNumberish, componentType: BigNumberish],
    [[bigint, bigint]],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "footArmor"
  ): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  getFunction(
    nameOrSignature: "handArmor"
  ): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "namePrefixes"
  ): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  getFunction(
    nameOrSignature: "nameSuffixes"
  ): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  getFunction(
    nameOrSignature: "necklaces"
  ): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  getFunction(
  ...
  ): TypedContractMethod<[suffixComponent: BigNumberish], [string], "view">;
  getFunction(
    nameOrSignature: "suffixes"
  ): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  getFunction(
  ...
  getEvent(
    ...
    AddComponentEvent.InputTuple,
    AddComponentEvent.OutputTuple,
    AddComponentEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    "AddComponent(uint256,uint256,string)": TypedContractEvent<
      AddComponentEvent.InputTuple,
      AddComponentEvent.OutputTuple,
      AddComponentEvent.OutputObject
    >;
    AddComponent: TypedContractEvent<
      AddComponentEvent.InputTuple,
      AddComponentEvent.OutputTuple,
      AddComponentEvent.OutputObject
    >;
