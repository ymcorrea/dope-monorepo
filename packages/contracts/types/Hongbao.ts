...
export namespace OpenedEvent {
  export type InputTuple = [typ: BigNumberish, id: BigNumberish];
  export type OutputTuple = [typ: bigint, id: bigint];
...
export interface Hongbao extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "transferMaintainerOwner"
  ...
  filters: {
    "Opened(uint8,uint256)": TypedContractEvent<
      OpenedEvent.InputTuple,
      OpenedEvent.OutputTuple,
      OpenedEvent.OutputObject
    >;
