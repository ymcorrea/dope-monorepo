...
export interface HustlerInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [AddressLike, IHustlerActions.SetMetadataStruct, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "mintTo(address,bytes)",
    values: [AddressLike, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "mintTo(address,(bytes4,bytes4,bytes2,uint8[4],uint8[4],uint8[10],bytes2,string),bytes)",
    values: [AddressLike, IHustlerActions.SetMetadataStruct, BytesLike]
  ): string;
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, IHustlerActions.SetMetadataStruct]
  ): string;
  encodeFunctionData(
...
export namespace AddRlesEvent {
  export type InputTuple = [part: BigNumberish, len: BigNumberish];
  export type OutputTuple = [part: bigint, len: bigint];
...
export interface Hustler extends BaseContract {
  ...
  bodyRle: TypedContractMethod<
    [part: BigNumberish, idx: BigNumberish],
    [string],
    "view"
  >;
  ...
  mintOGTo: TypedContractMethod<
    [to: AddressLike, m: IHustlerActions.SetMetadataStruct, data: BytesLike],
    [bigint],
    "nonpayable"
  >;
  ...
  setMetadata: TypedContractMethod<
    [hustlerId: BigNumberish, m: IHustlerActions.SetMetadataStruct],
    [void],
    "nonpayable"
  >;
  ...
  unequip: TypedContractMethod<
    [hustlerId: BigNumberish, slots: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[hustlerId: BigNumberish], [string[]], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "carParts"
  ): TypedContractMethod<[hustlerId: BigNumberish], [string[]], "view">;
  getFunction(
    nameOrSignature: "contractURI"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "enforcer"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "hustlerParts"
  ): TypedContractMethod<[hustlerId: BigNumberish], [string[]], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "mintTo(address,bytes)"
  ): TypedContractMethod<
    [to: AddressLike, data: BytesLike],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "mintTo(address,(bytes4,bytes4,bytes2,uint8[4],uint8[4],uint8[10],bytes2,string),bytes)"
  ): TypedContractMethod<
    [to: AddressLike, m: IHustlerActions.SetMetadataStruct, data: BytesLike],
    [bigint],
    "nonpayable"
  ...
  getEvent(
    ...
    AddRlesEvent.InputTuple,
    AddRlesEvent.OutputTuple,
    AddRlesEvent.OutputObject
  >;
  getEvent(
    key: "ApprovalForAll"
  ): TypedContractEvent<
  ...
  filters: {
    "AddRles(uint8,uint256)": TypedContractEvent<
      AddRlesEvent.InputTuple,
      AddRlesEvent.OutputTuple,
      AddRlesEvent.OutputObject
    >;
    AddRles: TypedContractEvent<
      AddRlesEvent.InputTuple,
      AddRlesEvent.OutputTuple,
      AddRlesEvent.OutputObject
    >;
